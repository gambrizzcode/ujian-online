...
<div class="wrapper">
    ...
    <div class="content-wrapper">
    	<section class="content-header">
          <h3><i class="fa fa-user"></i> Profil <?php echo $isi['nama']; ?></h3>
    	</section>
            ...
            <div class="box box-primary">
              <div class="box-body">
                  <div class="form-group">
                    ...
                    <h4>NIS : <b><?php echo $isi['nis']; ?></b></h4>
                    <h4>NO PESERTA : <b><?php echo $isi['nopes']; ?></b></h4>
                    <h4>NAMA : <b><?php echo $isi['nama']; ?></b></h4>
                    <h4>KELAS : <b><?php echo $isi['kelas']; ?></b></h4>
                    <input type="text" class="form-control" id="username" placeholder="USERNAME.." value="<?php echo $isi['username']; ?>"><br>
...
$(document).ready(function() {
  $('#update').click(function() {
    ...
    $.ajax({
      url: 'updateSiswa.php',
      type: 'GET',
      data: "nis="+nis+"&username="+username+"&password="+password,
